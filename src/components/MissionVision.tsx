    ...
    return (
        <>
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className='rounded-tr-2xl bg-white rounded-bl-2xl mx-auto flex flex-col shadow-md p-4 max-h-full border-r-blue-500 border-r-4'>
            ...
            <motion.div
                ...
                animate="show"
                exit="hidden"
                className='rounded-tr-2xl bg-white rounded-bl-2xl mx-auto flex flex-col shadow-md p-4 border-l-red-600 border-l-4'>
                <h4 className='text-2xl font-medium mb-4 text-right '>Our <span className='text-red-600'>Vision</span> </h4>
